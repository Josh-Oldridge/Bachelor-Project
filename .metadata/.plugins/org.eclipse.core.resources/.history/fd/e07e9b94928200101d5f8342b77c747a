...
/* Live rule flags
   - enc_rule_flags: most recently computed flags (for telemetry)
   - win_rule_flags: flags aligned to the *window just handed to the NN* */
