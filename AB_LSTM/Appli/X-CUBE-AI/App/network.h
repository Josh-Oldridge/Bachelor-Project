...
#define AI_NETWORK_ORIGIN_MODEL_NAME   "lstm_ab_encoder"
...
#define AI_NETWORK_IN_1_HEIGHT      (20)
#define AI_NETWORK_IN_1_CHANNEL     (10)
#define AI_NETWORK_IN_1_SIZE        (200)
#define AI_NETWORK_IN_1_SIZE_BYTES  (800)
